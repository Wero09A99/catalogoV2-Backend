...
export interface ApiCategoriaDeProductoCategoriaDeProducto
  ...
  info: {
    displayName: 'CategoriaDeProducto';
...
export interface ApiContactoContacto extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    Numero_de_telefono_1: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Numero_de_telefono_2: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiInicioInicio extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DescripcionRich: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Imagen_titulo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria_de_producto: Schema.Attribute.Relation<
      ...
      'api::categoria-de-producto.categoria-de-producto'
    >;
    Color: Schema.Attribute.Enumeration<['Green', 'Red', 'Gray', 'Black']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
